...
function LogicalDemoContent({ allInfo,addInputField }) {
  console.log('Current field information in logicalDemoContent.js:',allInfo);
  let {currentPage,prevIndex,prevFieldType,newFieldType } = allInfo;
  ...
  return (
    <div className="logical-content ">
      <div className="top-content">
        ...
        <Button variant="primary" onClick={()=>addInputField(currentPage,prevIndex,prevFieldType,newFieldType)}>
